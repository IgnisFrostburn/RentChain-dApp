				...
				<div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-20">
					<div className="space-y-4">
						...
						<p className="text-gray-500 font-bold text-lg max-w-md leading-snug">
							Manage your cryptographically secured rental assets and active
							leases.
						</p>
					</div>
				...
				{isLoading ? (
					...
					<div className="bg-white/[0.02] backdrop-blur-3xl rounded-[4rem] p-24 text-center border border-dashed border-white/10 relative overflow-hidden">
						...
						<div className="relative z-10">
							...
							<p className="text-gray-500 max-w-sm mx-auto mb-10 font-bold text-lg leading-snug">
								Connect your Cardano wallet to view your active cryptographic
								leases and portfolio.
							</p>
							<Button
					...
					<div className="bg-white/[0.02] backdrop-blur-3xl rounded-[4rem] p-24 text-center border border-dashed border-white/10 relative overflow-hidden">
						...
						<div className="relative z-10">
							...
							<p className="text-gray-500 max-w-sm mx-auto mb-10 font-bold text-lg leading-snug">
								No cryptographic agreements detected at this address. Initialize
								a new lease from the terminal.
							</p>
							<Link href="/listings">
								<Button
									size="lg"
