...
export default function Navbar() {
    ...
    return (
        <>
                                ...
                                <div className="relative">
                                    <Button
                                        ...
                                        <div className="flex flex-col items-start leading-none ml-1">
                                            <span className="capitalize text-xs font-black">
                                                {connectedWalletName}
                                            </span>
                                            {walletAddress && (
                                        ...
                                        <ChevronDown
                                            className={cn(
                                                "w-3 h-3 transition-transform ml-1 opacity-50",
            ...
            {showWalletModal && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-2xl flex items-center justify-center z-[100] p-4 animate-in fade-in duration-500">
                                ...
                                {availableWallets.length === 0 ? (
                                    ...
                                    availableWallets.map((w) => (
                                        <button
                                            ...
                                            className="w-full flex items-center justify-between p-4 rounded-3xl border border-white/5 bg-white/[0.02] hover:bg-white/5 hover:border-blue-500/50 transition-all group">
                                            <div className="flex items-center gap-6">
                                                <div className="w-8 h-8 bg-white rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-xl shadow-black">
                                                    <div className="w-4 h-4 bg-blue-600 rounded-lg shadow-inner" />
                                                </div>
